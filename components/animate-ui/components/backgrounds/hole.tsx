...
function HoleBackground({
  ...
  const drawLines = React.useCallback((ctx: CanvasRenderingContext2D) => {
    const canvas = stateRef.current.linesCanvas;
  ...
  return (
    ...
    >
      ...
      <motion.div
        className={cn(
          "absolute top-[-71.5%] left-1/2 z-[3] w-[30%] h-[140%] rounded-b-full blur-3xl opacity-75 dark:mix-blend-plus-lighter mix-blend-plus-darker [transform:translate3d(-50%,0,0)] bg-position-[0%_100%] [background-size:100%_200%]",
